...
namespace Faridlab\LaravelExportable\Providers;

use Illuminate\Support\ServiceProvider;

class LaravelExportableServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/laravel-exportable.php' => config_path('laravel-exportable.php'),
        // ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-exportable');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-exportable');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/laravel-exportable'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'laravel-exportable');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/laravel-exportable'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \Faridlab\LaravelExportable\Console\Commands\LaravelExportableCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/laravel-exportable'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/laravel-exportable.php', 'laravel-exportable'
        // );
    }
}
